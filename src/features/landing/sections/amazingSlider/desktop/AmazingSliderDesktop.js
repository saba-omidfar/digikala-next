...
export default function AmazingSliderDesktop({ incredibbleOffers }) {
  return (
                  ...
                  >
                    ...
                    >
                      <picture>
                        <source
                          type="image/webp"
                          srcSet="/images/png/specialCarousel/box.webp"
                        />
                        <source
                          type="image/jpeg"
                          srcSet="/images/png/specialCarousel/box.png"
                        />
                        <img
                          className={styles.logo}
                          src="/images/png/specialCarousel/box.png"
                          width="145"
                          height="115"
                          alt="شگفت انگیز"
                          title=""
