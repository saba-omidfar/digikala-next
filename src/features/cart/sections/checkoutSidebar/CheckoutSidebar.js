        ...
        {userIsLoading ? (
          ...
          <>
            ...
            {!user ? (
              ...
              <>
                {/* When User Is Logged In And ActiveTab === "basket" */}
                {/* {activeTab === "basket" ? (
                  <div className={styles.cart_continue_shopping_container}>
                    <div style={{ padding: "0 20px" }}>
                      <div
                        className={
                          styles.cart_continue_products_price_container
                        }
                      >
                        <div className="d-flex align-items-center">
                          <div
                            className={styles.cart_continue_products_price_text}
                          >
                            <span>
                              قیمت کالاها (
                              {toPersianDigits(userCart?.cart?.items_count)})
                            </span>
                          </div>
                        </div>
                          ...
                          <div className="d-flex align-items-center flex-wrap justify-content-end">
                            <div className="d-flex align-items-center justify-content-start">
                              <div className="d-flex justify-content-start align-items-center gap-1">
                                <span
                                  className={
                                    styles.cart_continue_products_price
                                  }
                                >
                                  {(cart?.rrp_price / 10).toLocaleString(
                                    "fa-IR",
                                  )}
                                </span>
                              </div>
                      ...
                      {hasCartInsurance ? (
                        ...
                        >
                          <div className="d-flex align-items-center">
                            <div
                              className={styles.cart_continue_total_price_text}
                            >
                              <span>قیمت بیمه</span>
                            </div>
                          </div>
                      ...
                      <div
                        className={styles.cart_continue_total_price_container}
                      >
                        <div className="d-flex align-items-center">
                          <div
                            className={styles.cart_continue_total_price_text}
                        ...
                        <div className="d-flex align-items-center me-auto">
                          <div className="d-flex align-items-center flex-wrap justify-content-end">
                            <div className="d-flex align-items-center justify-content-start">
                              <div className="d-flex justify-content-start align-items-center gap-1">
                                <span
                                  className={styles.cart_continue_total_price}
                                >
                              ...
                              <div className="d-flex align-items-center justify-content-between">
                                <div className="d-flex align-items-center">
                                  <div className="d-flex" aria-hidden="false">
                                    <svg
                                      className={
                                        styles.cart_continue_total_icon
                                      }
                                    >
                                      <use href="#toman"></use>
                                    </svg>
                      ...
                      {cart.discount_percent !== 0 ? (
                        <div
                          className={
                            styles.cart_continue_discount_total_container
                          }
                        >
                          <div className="d-flex align-items-center">
                            <div
                              className={
                                styles.cart_continue_discount_total_text
                              }
                            >
                          ...
                          <div className="d-flex align-items-center me-auto">
                            <div className="d-flex align-items-center flex-wrap justify-content-end">
                              <span
                                className={
                                  styles.cart_continue_discount_percent
                                }
                              >
                                {`(${cart?.discount_percent?.toLocaleString(
                                  "fa-IR",
                                )}٪)`}
                              </span>
                              <div className="d-flex align-items-center justify-content-start">
                                <div className="d-flex justify-content-start align-items-center gap-1">
                                  <span
                                    className={
                                      styles.cart_continue_discount_price
                                    }
                                  >
                                    {`${(
                                      cart.total_discount / 10
                                    )?.toLocaleString("fa-IR")}`}
                                  </span>
                                </div>
                                <div className="d-flex align-items-center justify-content-between">
                                  <div className="d-flex align-items-center">
                                    <div className="d-flex" aria-hidden="false">
                                      <svg
                                        className={
                                          styles.cart_continue_discount_icon
                                        }
                                      >
                                        <use href="#toman"></use>
                                      </svg>
                      ...
                      <div className={styles.cart_continue_btn_container}>
                        <Link
                          className={styles.cart_continue_link}
                          ...
                          <div className={styles.checkout_sidebar_header}>
                            <div className={styles.checkout_sidebar_header}>
                              <div className="d-flex align-items-center justify-content-between">
                                <span
                                  className={
                                    styles.checkout_sidebar_header_text
                                  }
                                >
                                  جزئیات پرداخت
                                </span>
                    ...
                    >
                      {isLoadingAddToCart ? (
                        ...
                        <div className="d-flex align-items-center justify-content-center position-relative flex-grow-1">
                          ...
                          <span
                            className={styles.add_to_cart_from_list_btn_text}
                          >
                ...
                <div className={styles.checkout_sidebar_container}>
                  <div className={styles.checkout_sidebar}>
                    <div className={styles.checkout_sidebar_bg}>
                      <div className="d-flex flex-column gap-1">
                        <div
                          className={styles.checkout_sidebar_header_container}
                        >
                          <div className={styles.checkout_sidebar_header}>
                            <div className="d-flex align-items-center justify-content-between">
                              <span
